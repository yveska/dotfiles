...
vim.opt.showmode = false -- do not show mode, we'll have it in statusline instead
...
vim.opt.undofile = true -- create an undofile
...
-- Folding --  requires treesitter available at runtime; safe failback if not
vim.opt.foldmethod = "expr" -- use expression for folding
vim.opt.foldexpr = "v:lua.vim.treesitter.foldexpr()" -- use treesitter for folding
vim.opt.foldlevel = 99 -- start with all folds op
vim.opt.foldtext = ""
